...
class Trix_Email extends CI_Email {
...
*/
    ...
    {
        // шаблон
        $template = CI::$APP->load->view('email_templates/'. $this->template, array(), TRUE);
        
        // загружаем парсер
        CI::$APP->load->library('parser');
        
        // парсим сообщение
        $message = CI::$APP->parser->parse_string($template, $this->data, TRUE);
