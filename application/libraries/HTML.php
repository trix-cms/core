...
class HTML {
     ...
     * mixed attributes
     */
    static function image($src, $attributes = '')
    {
    ...
    {
        return '<link '. HTML::parse_attributes($attributes) .'>';
    }
    ...
    static function options($options, $default = '')
    {
        ...
        {
            $html .= self::option($value, $content, $value == $default ? true : false);
        }
    ...
    {
        return '<option value="'. $value .'"'. ($selected ? ' selected="selected" ' : ' ') . HTML::parse_attributes($attributes) .' >'. $content  .'</option>';
    }
    ...
    static function button($name, $value, $attributes = '')
    {
        ...
        return HTML::tag('button', $value, $attributes);
    }
}